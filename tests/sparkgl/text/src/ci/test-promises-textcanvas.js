 ...
 * author: sgladk001c
 *
 * This test will ensure that pxTextCanvas is sending promises as expected
 */
...
px.import({
    ...
    let fontUrlBase = basePackageUri + "/../../static/fonts/";
    ...
    let measureText = function(params) {
        return new Promise(function(resolve, reject) {
            var results = [];
            logger.message("Executing", params.name, params.description);
            let text = 'I need to measure that';
    ...
    console.error("Import failed for test-promises-textcanvas.js: " + err);
});
